defmodule Todo.TodoContextTest do
  ...
  describe "todos" do
    ...
    test "create_todo_schema/1 with valid data creates a todo_schema" do
      ...
      assert todo_schema.completed == true
      assert todo_schema.description == "some description"
    ...
    test "update_todo_schema/2 with valid data updates the todo_schema" do
      ...
      assert todo_schema.completed == false
      assert todo_schema.description == "some updated description"
